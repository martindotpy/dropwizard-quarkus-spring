...
export const zOpenapiServiceResourceSnapshot = z.object({
  ...
  usedMemoryMiB: z.coerce
    ...
    .optional(),
  nonHeapUsedMemoryBytes: z.coerce
    .bigint()
    .min(BigInt("-9223372036854775808"), {
      error: "Invalid value: Expected int64 to be >= -9223372036854775808",
    })
    ...
    .optional(),
  nonHeapCommittedMemoryBytes: z.coerce
    .bigint()
    .min(BigInt("-9223372036854775808"), {
      error: "Invalid value: Expected int64 to be >= -9223372036854775808",
    })
    ...
    .optional(),
  nonHeapMaxMemoryBytes: z.coerce
    .bigint()
    .min(BigInt("-9223372036854775808"), {
      error: "Invalid value: Expected int64 to be >= -9223372036854775808",
    })
  ...
  peakThreadCount: z
    ...
    .optional(),
  processCpuLoad: z.number().optional(),
  systemCpuLoad: z.number().optional(),
  processCpuTimeNs: z.coerce
    .bigint()
    .min(BigInt("-9223372036854775808"), {
      error: "Invalid value: Expected int64 to be >= -9223372036854775808",
    })
  ...
  processRssBytes: z.coerce
    ...
    .optional(),
  containerMemoryUsedBytes: z.coerce
    .bigint()
    .min(BigInt("-9223372036854775808"), {
      error: "Invalid value: Expected int64 to be >= -9223372036854775808",
    })
    ...
    .optional(),
  containerMemoryUsedMiB: z.coerce
    .bigint()
    .min(BigInt("-9223372036854775808"), {
      error: "Invalid value: Expected int64 to be >= -9223372036854775808",
    })
